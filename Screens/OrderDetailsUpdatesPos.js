...
import { FlatList, Platform, TouchableOpacity, ActivityIndicator } from 'react-native';
...
class OrderDetailsUpdatesPos extends Component {
      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          <View
            ...
            {this.state.data.order_type != 'TakeAway' && this.state.data.order_type != 'Delivery' ? (
              ...
              <Text
                ...
                Order Type : {this.state.data.order_type}
              </Text>
  ...
  render() {
    return (
      <View>
                ...
                <View
                  ...
                  <TouchableOpacity style={style.acceptButton}
                    ...
                    <LinearGradient
                      ...
                      style={[
                        style.acceptButton,
                        { backgroundColor: '#5BC2C1', width: '100%', padding: 10 },
                      ]}>
              ...
              <>
                {this.props.buttonLoading ? (
                  ...
                  <View
                    ...
                    <TouchableOpacity style={style.acceptButton}
                      onPress={() => this.props.change_order_status('out for delivery')}>
                      <LinearGradient
                        colors={['#5BC2C1', '#296E84']}
                        style={[
                          style.acceptButton,
        ...
        {
          this.props.data.instruction != '' && this.props.data.instruction != null ?
            <View style={{
              ...
              <Text style={styles.h4}>Instructions : <Text style={{ fontFamily: "Poppins-Medium" }}>{this.props.data.instruction}</Text></Text>
            </View>
            :
            <></>
        }
        ...
        <View
          ...
          <View style={{ padding: 5, paddingLeft: 12 }}>
            ...
            <Text style={{ color: '#000', fontSize: RFValue(12, 580), paddingBottom: 20 }}>
            ...
            <View style={style.modalView}>
              ...
              <View>
                {this.props.buttonLoading ? (
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      this.props.change_order_status('in_process', this.state.time),
                        this.setState({ modalVisible: false })
                    }}
...
class Loader extends Component {
  render() {
    return (
      <View>
        <SkeletonPlaceholder>
          <View style={{ width: win.width / 1.05, height: 110, marginLeft: 10, marginTop: 10, borderRadius: 10 }} />
          <View style={{ width: win.width / 1.05, height: 110, marginLeft: 10, marginTop: 10, borderRadius: 10 }} />
          <View style={{ width: win.width / 1.05, height: 110, marginLeft: 10, marginTop: 10, borderRadius: 10 }} />
          <View style={{ width: win.width / 1.05, height: 110, marginLeft: 10, marginTop: 10, borderRadius: 10 }} />
          <View style={{ width: win.width / 1.05, height: 110, marginLeft: 10, marginTop: 10, borderRadius: 10 }} />
...
export default OrderDetailsUpdatesPos;