      ...
      // ()=>this.props.navigation.navigate('FirstUserProfile')
        return(
            <View style={style.container}>
              ...
              <Text style={[styles.p,{top:-15}]}>+91 {this.props.route.params.contact_no} <Text style={{color:"#326bf3",fontFamily:"Raleway-Regular"}}onPress={()=>this.props.navigation.navigate('MobileLogin')} > Edit</Text></Text>
...
/>
        ...
        :
            <View style={{alignSelf:"center",marginTop:-32}}>
              <Text onPress={()=>this.resend()} style={[styles.p,{color:"#326bf3"}]} >RESEND OTP?
               </Text>
            </View>
    }
            </View>
