                     ...
                     {this.state.status ?
                        <>
                           ...
                           {this.state.buttonLoading ?
                              ...
                              <TouchableOpacity style={style.updateButton}
                        ...
                        <>
                           {/* view for image */}
                           <View>
                              <Image source={require('../img/activepayout.webp')} style={style.img} />
                           </View>
                           ...
                           <View style={{ width: Dimensions.get('window').width / 1.05, alignSelf: "center", justifyContent: "center", alignContent: "center" }}>
                              ...
                              <View>
                                 <TouchableOpacity style={style.mailButton} onPress={() => Linking.openURL('mailto:support@weazy.in')}>
